...
public class GraphThrottlePosition extends AppCompatActivity implements OnChartGestureListener, OnChartValueSelectedListener {
    ...
    {
        if(this.highestGraphedValue > 99)
        {
            /*This creates an Alert dialog on this screen, it also sets it so the user can cancel the message
            ...
            //Setting the title and message from the string.xml
            builder2.setTitle(GraphThrottlePosition.this.getString(R.string.NormalValues));
            builder2.setMessage(GraphThrottlePosition.this.getString(R.string.NormalValInstruct));
    ...
    private void downloadData()
    {
        ...
        Log.d("VEH_KEY - THROTTLE POS", vehicle_key);
        ...
        database.addChildEventListener(new ChildEventListener()
        {
            public void onChildAdded(DataSnapshot dataSnapshot, String prevChildKey)
            {
                ...
                System.out.println("getThrottlePosition: " + Objects.requireNonNull(vehicleData).getThrottlePosition());
    ...
    private void setData(int key, VehicleData vehicleData)
    {
        ...
        throttlePositionList.add(new Entry(key + 2, graphValue));
